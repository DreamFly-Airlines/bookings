...
namespace Bookings.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250923052734_AddFareConditionsConversion")]
    partial class AddFareConditionsConversion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.AggregateRoots.Booking", b =>
                {
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Aircraft", b =>
                {
                    b.Property<string>("AircraftCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Airport", b =>
                {
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.BoardingPass", b =>
                {
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Flight", b =>
                {
                    b.Property<int>("FlightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Route", b =>
                {
                    b.Property<string>("AircraftCode")
                        .IsRequired()
                        .HasMaxLength(3)
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Ticket", b =>
                {
                    b.Property<string>("TicketNo")
                        .HasMaxLength(13)
                        .HasColumnType("character(13)")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.TicketFlight", b =>
                {
                    b.Property<string>("TicketNo")
                        .HasMaxLength(13)
                        .HasColumnType("character(13)")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.ValueObjects.Seat", b =>
                {
                    b.Property<string>("AircraftCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.BoardingPass", b =>
                {
                    b.HasOne("Bookings.Domain.Bookings.Entities.TicketFlight", null)
                        .WithOne()
                        .HasForeignKey("Bookings.Domain.Bookings.Entities.BoardingPass", "TicketNo", "FlightId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Flight", b =>
                {
                    b.HasOne("Bookings.Domain.Bookings.Entities.Aircraft", null)
                        .WithMany()
                        .HasForeignKey("AircraftCode")
                        .IsRequired()
                        .HasConstraintName("flights_aircraft_code_fkey");

                    b.HasOne("Bookings.Domain.Bookings.Entities.Airport", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.Ticket", b =>
                {
                    b.HasOne("Bookings.Domain.Bookings.AggregateRoots.Booking", null)
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Bookings.Domain.Bookings.Entities.TicketFlight", b =>
                {
                    b.HasOne("Bookings.Domain.Bookings.Entities.Flight", null)
                        .WithMany()
                        .HasForeignKey("FlightId")
                        .IsRequired()
                        .HasConstraintName("ticket_flights_flight_id_fkey");

                    b.HasOne("Bookings.Domain.Bookings.Entities.Ticket", null)
